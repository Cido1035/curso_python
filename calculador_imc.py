...
# 2) Atividade: Calculadora de IMC com Classificação e
# Comparações
# 🎯 Objetivo:
# Criar um programa que:
# ● Solicite dados do usuário.
# ● Calcule o IMC (Índice de Massa Corporal).
# ● Classifique o resultado usando operadores e tipos de dados.
# ● Mostre comparações de forma booleana.
